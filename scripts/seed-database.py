#!/usr/bin/env python3
"""Seed database with production-like data for FactoryFone Admin Portal."""
...
TICKET_SUBJECTS = [
    ...
    ("App not working", "The FactoryFone app keeps crashing"),
...
def main():
    print("=" * 60)
    print("FactoryFone Database Seeder")
    print("=" * 60)
